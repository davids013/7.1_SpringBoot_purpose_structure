...
### Лекция 7.1: Spring boot. Назначение, внутреннее устройство
...
### Лекция 7.6: TestContainers, Kubernetes
...
class DemoApplicationTests {
    ...
    void contextLoads() {
        ResponseEntity<String> forEntity = restTemplate.getForEntity(
                "http://localhost:" + myapp.getMappedPort(8080) + "/profile", String.class);
